...
fetch(`${API_URL}/db`)
    ...
    .then(data => {
        ...
        // Informações do primeiro confronto
        ...
        // Informações do próximo confronto
    ...
    // Seta para subir ao topo da tela
